...
class Cube(ExtendedBaseModel):
    def __init__(self, app, vao_name='cube', tex_id=0, pos=(0, 0, 0), rot=(0, 0, 0), scale=(0.1, 0.1, 0.1)):
        super().__init__(app, vao_name, tex_id, pos, rot, scale)
...
# siguiendo esta misma logica pondremos mas modelos
...
##class Cesped(ExtendedBaseModel):
##    def __init__(self, app, vao_name='cesped', tex_id='cesped',
##                 pos=(0, 0, 0), rot=(0, 0, 0), scale=(1, 1, 1)):
##        super().__init__(app, vao_name, tex_id, pos, rot, scale)
##
##
##
##class detalles(ExtendedBaseModel):
##    def __init__(self, app, vao_name='Detalles', tex_id='Detalles',
##                 pos=(0, 0, 0), rot=(0, 0, 0), scale=(1, 1, 1)):
##        super().__init__(app, vao_name, tex_id, pos, rot, scale)
##
##
